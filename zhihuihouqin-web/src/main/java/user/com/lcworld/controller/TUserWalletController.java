...
public class TUserWalletController {
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions("tuserwallet:list")
	...
	@RequiresPermissions("tuserwallet:info")
	 ...
	 */
	@RequestMapping("/save")
	@RequiresPermissions("tuserwallet:save")
	...
	@RequiresPermissions("tuserwallet:update")
	...
	@RequiresPermissions("tuserwallet:delete")
