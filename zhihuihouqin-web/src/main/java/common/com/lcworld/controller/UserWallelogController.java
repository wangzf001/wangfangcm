 ...
 */
@RestController
@RequestMapping("userwallelog")
public class UserWallelogController {
	@Autowired
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions("userwallelog:list")
	...
	@RequiresPermissions("userwallelog:info")
	 ...
	 */
	@RequestMapping("/save")
	@RequiresPermissions("userwallelog:save")
	...
	@RequiresPermissions("userwallelog:update")
	...
	@RequiresPermissions("userwallelog:delete")
