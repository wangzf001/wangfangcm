 ...
 */
@RestController
@RequestMapping("userwalleorder")
public class UserWalleorderController {
	@Autowired
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions("userwalleorder:list")
	...
	@RequiresPermissions("userwalleorder:info")
	 ...
	 */
	@RequestMapping("/save")
	@RequiresPermissions("userwalleorder:save")
	...
	@RequiresPermissions("userwalleorder:update")
