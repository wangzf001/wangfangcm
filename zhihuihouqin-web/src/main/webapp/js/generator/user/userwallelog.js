...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.userWallelog.id == null ? "../../userwallelog/save" : "../../userwallelog/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.userWallelog),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../userwallelog/info/"+id, function(r){
                vm.userWallelog = r.userWallelog;
            });
		},
