...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.tUserBankCard.id == null ? "../../tuserbankcard/save" : "../../tuserbankcard/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.tUserBankCard),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../tuserbankcard/info/"+id, function(r){
                vm.tUserBankCard = r.tUserBankCard;
            });
		},
