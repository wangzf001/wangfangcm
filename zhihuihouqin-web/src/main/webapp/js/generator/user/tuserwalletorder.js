...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.tUserWalletOrder.id == null ? "../../tuserwalletorder/save" : "../../tuserwalletorder/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.tUserWalletOrder),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../tuserwalletorder/info/"+id, function(r){
                vm.tUserWalletOrder = r.userWalleorder;
            });
		},
