$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '图书编号', name: 'bookid', index: 'bookid', width: 80 }, 			
...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.tsjyfwComment.id == null ? "../../tsjyfwcomment/save" : "../../tsjyfwcomment/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.tsjyfwComment),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../tsjyfwcomment/info/"+id, function(r){
