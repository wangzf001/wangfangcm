$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '', name: 'searchid', index: 'searchid', width: 80 }, 			
			{ label: '是否正本 1：是 0：否', name: 'original', index: 'original', width: 80 }, 			
			{ label: '图书id', name: 'bookid', index: 'bookid', width: 80 }, 			
			{ label: '借阅状态 1:在架上，2：已借出', name: 'borrowstatus', index: 'borrowstatus', width: 80 }			
        ],
		viewrecords: true,
        height: 385,
        rowNum: 10,
