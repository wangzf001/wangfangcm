...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.dcfwGetfoodtime.id == null ? "../../dcfwgetfoodtime/save" : "../../dcfwgetfoodtime/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.dcfwGetfoodtime),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../dcfwgetfoodtime/info/"+id, function(r){
                vm.dcfwGetfoodtime = r.dcfwGetfoodtime;
            });
		},
