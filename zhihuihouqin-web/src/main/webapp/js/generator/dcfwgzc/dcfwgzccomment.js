...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.dcfwGzcComment.id == null ? "../../dcfwgzccomment/save" : "../../dcfwgzccomment/update";
			$.ajax({
				type: "POST",
			    url: url,
			    data: JSON.stringify(vm.dcfwGzcComment),
			    success: function(r){
			    	if(r.errCode === 0){
		...
		getInfo: function(id){
			$.get("../../dcfwgzccomment/info/"+id, function(r){
                vm.dcfwGzcComment = r.dcfwGzcComment;
            });
		},
		...
		exportExcel: function (event) {
			...
			location.href = "../../dcfwgzccomment/exportExcel"+str;
		}
	}
});