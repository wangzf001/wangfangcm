...
public class TdhdActivityDTO {
    ...
    //活动图片
    private List<String> aPhoto = new ArrayList<String>();
    //发布人姓名
    ...
    public void setaPhoto(String photoStr) {
        if(ValidateUtil.isValid(photoStr)){
            aPhoto.addAll(Arrays.asList(photoStr.split(",")));
        }
    }
