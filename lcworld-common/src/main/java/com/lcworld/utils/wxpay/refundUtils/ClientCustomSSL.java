 ...
 *
 */
package com.lcworld.utils.wxpay.refundUtils;
...
import com.lcworld.utils.WebAppConfig;
...
//        FileInputStream instream = new FileInputStream(new File("D:/Program Files/MyEclipse 6.5/workspace/weidian/WebRoot/cer/apiclient_cert.p12"));//P12文件目录
        String path = WebAppConfig.getInstance().getAsString("apiclient.cert.path");
        ...
        String pwd = ConstantUtil.PARTNER;
//        String pwd = WebAppConfig.getInstance().getAsString("apiclient.this.pwd");
