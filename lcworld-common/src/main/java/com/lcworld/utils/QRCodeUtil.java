...
public class QRCodeUtil {
	 ...
	 * @throws Exception
	 */
	public static InputStream encode(String content, String logoPath, String destPath, String fileName,
	...
	public static void main(String[] args) throws Exception {
		...
		// 含Logo，不指定二维码图片名
		// QRCodeUtil.encode(text, "e:\\70621203.jpg", "e:\\", true);
		// 含Logo，指定二维码图片名
		InputStream stream = QRCodeUtil.encode(text, "e:\\70621203.jpg", "e:\\", "qrcode", true);
