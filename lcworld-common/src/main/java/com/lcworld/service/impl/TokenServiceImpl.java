...
import com.lcworld.dao.TokenDao;
...
public class TokenServiceImpl implements TokenService {
	...
	@Override
	public Map<String, Object> createToken(long userId,int signid ,int stid) {
		//生成一个token
		...
		if(tokenEntity == null){
			...
			if(stid != 0){
				tokenEntity.setSignid(signid);
				tokenEntity.setStid(stid);
			}
