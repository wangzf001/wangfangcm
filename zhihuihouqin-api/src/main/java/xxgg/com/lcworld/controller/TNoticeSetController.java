...
public class TNoticeSetController {
	 ...
	 */
	@RequestMapping("/list")
	@RequiresPermissions("tnoticeset:list")
	...
	@RequiresPermissions("tnoticeset:info")
	public R info(@PathVariable("id") Integer id){
		TNoticeSetEntity tNoticeSet = tNoticeSetService.queryObject(id);
		
		return R.ok().put("tNoticeSet", tNoticeSet);
	}
	 ...
	 */
	@RequestMapping("/save")
	@RequiresPermissions("tnoticeset:save")
	...
	@RequiresPermissions("tnoticeset:update")
	...
	@RequiresPermissions("tnoticeset:delete")
